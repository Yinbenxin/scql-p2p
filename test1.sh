...
./brokerctl create table tb --project-id "demo2" --columns "统一社会信用代码 string, 付款单位 string, 收款单位统一社会信用代码 string, 收款单位 string, 金额 double" --ref-table bob.银行A测试数据 --db-type mysql --host http://127.0.0.1:8280
./brokerctl create table tc --project-id "demo2" --columns "统一社会信用代码 string, 付款单位 string, 收款单位统一社会信用代码 string, 收款单位 string, 金额 double" --ref-table charlie.银行B测试数据 --db-type mysql --host http://127.0.0.1:8380
